...
export default class HealthController {
  ...
  @Get('/')
  public home() {
    return { status_code: 200, message: 'Welcome to NestJs auth Backend Endpoint' };
  }
  ...
  @Get('api/v1')
  public v1() {
    return { status_code: 200, message: 'Welcome to version 1 of NestJs auth Backend Endpoint' };
  }
